...
<template>
  ...
  <el-checkbox class="firefly" v-model="checked">备选项</el-checkbox>
</template>
<script>
  export default {
    data() {
...
```html
<template>
  <el-checkbox class="firefly" v-model="checked1" disabled>备选项1</el-checkbox>
  <el-checkbox class="firefly" v-model="checked2" disabled>备选项</el-checkbox>
</template>
<script>
  export default {
    data() {
...
<template>
  <el-checkbox-group v-model="checkList">
    <el-checkbox class="firefly" label="复选框 A"></el-checkbox>
    <el-checkbox class="firefly" label="复选框 B"></el-checkbox>
    <el-checkbox class="firefly" label="复选框 C"></el-checkbox>
    <el-checkbox class="firefly" label="禁用" disabled></el-checkbox>
    <el-checkbox class="firefly" label="选中且禁用" disabled></el-checkbox>
  </el-checkbox-group>
</template>
